...
async def test_parquet_survives_restart(manager: ManagerClient) -> None:
...
async def test_storage_format_converges_on_every_replica(
        manager: ManagerClient, fmt, extra, expect_parquet) -> None:
...
async def test_tablet_migration_preserves_parquet(manager: ManagerClient) -> None:
