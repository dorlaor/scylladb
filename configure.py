...
scylla_core = (['message/messaging_service.cc',
                ...
                'sstables/lance/format/lance_metadata.cc',
                'sstables/lance/format/lance_encodings.cc',
                'sstables/lance/format/lance_writer.cc',
                'sstables/lance/format/lance_reader.cc',
                'sstables/lance/glue.cc',
                'sstables/lance/reader.cc',
